...
def generate_one_pseudo_obs(config, path_data, path_dustmaps, extinction=True):
    ...
    :return: a dictionary for each config with the configuration, the GRB coordinates and observation date, the observed magnitude, the limiting magnitude at the observation time and the filter used at the moment of the detection
    """

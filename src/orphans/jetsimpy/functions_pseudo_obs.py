...
sys.path.append('/home/masson/rubin_sim/rubin_sim')
...
from modules.grb_interface import make_grb_spectrum, dump_wl_Fnu_spectrum
...
def df_obs(P, df_sky, time_bins, lsst):
    ...
    for obs_id, obs_t in time_bins.to_dict().items():
        wl_full_band, freq_full_band, t, Fnu_Jy[obs_id] = make_grb_spectrum(E0=P['Eiso'],
                                                                            z=P['z'], n0=P['n0'],
                                                                            thetaObs=P['theta_v'],
                                                                            thetaCore=P['theta_c'],
                                                                            lf=P['lf'],

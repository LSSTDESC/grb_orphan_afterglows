...
This module provides a number of generic tools to use to generate a simulation of an afterglow observation using
rubin_sim
"""
...
def grb_obs_duration(df_sky, grb_time):
    """ Compute the observation time in the GRB time frame, i.e. from GRB T0
    """
